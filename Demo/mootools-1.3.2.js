...
web build:
 - http://mootools.net/core/f4ff742165d2734abdda2fce45c5a316

packager build:
 - packager build Core/Core Core/Array Core/String Core/Function Core/Event Core/Class Core/Element Core/Element.Style Core/Element.Event Core/Element.Dimensions Core/Fx.Tween
...
};}});Number.implement(a);})(["abs","acos","asin","atan","atan2","ceil","cos","exp","floor","log","max","min","pow","sin","sqrt","tan"]);(function(){var k=this.document;
var i=k.window=this;var b=1;this.$uid=(i.ActiveXObject)?function(e){return(e.uid||(e.uid=[b++]))[0];}:function(e){return e.uid||(e.uid=b++);};$uid(i);$uid(k);
